...
const tools = [
    {
        name: "list_agents",
        description: "List all active agents in the AIProx registry. Optionally filter by capability or payment rail. Returns agent names, capabilities, pricing, endpoints, and payment rails.",
        inputSchema: {
            type: "object",
            properties: {
                capability: {
                    type: "string",
                    description: "Filter by capability (e.g. ai-inference, market-data, image-generation, web-search)",
                },
                rail: {
                    type: "string",
                    description: "Filter by payment rail (e.g. bitcoin-lightning, solana-usdc)",
                },
            },
            required: [],
        },
    ...
    {
        name: "get_agent",
        description: "Get full details for a specific agent in the AIProx registry by name. Returns endpoint, pricing, payment rail, capabilities, and models.",
        inputSchema: {
            type: "object",
            properties: {
                name: {
                    type: "string",
                    description: "Agent name (e.g. lightningprox, solanaprox, lpxpoly)",
                },
            },
            required: ["name"],
        },
    ...
    {
        name: "find_agent",
        description: "Find the best agent for a specific task. Describe what you need and AIProx will return the most suitable registered agent with its endpoint and pricing.",
        inputSchema: {
            type: "object",
            properties: {
                task: {
                    type: "string",
                    description: "What you need (e.g. 'AI inference paid with Bitcoin', 'Polymarket analysis', 'image generation')",
                },
                preferred_rail: {
                    type: "string",
                    description: "Preferred payment rail (bitcoin-lightning or solana-usdc). Optional.",
                },
            },
            required: ["task"],
        },
    ...
    {
        name: "register_agent",
        description: "Register a new agent in the AIProx registry. Free to register. New registrations are pending until verified by the AIProx team.",
        inputSchema: {
            type: "object",
            properties: {
                name: {
                ...
                capability: {
                    type: "string",
                    description: "Primary capability (ai-inference, market-data, image-generation, web-search, etc.)",
                },
                rail: {
                    type: "string",
                ...
                payment_address: {
                    type: "string",
                    description: "Your Lightning address or Solana wallet for receiving payments",
                },
                models: {
                    type: "array",
                    items: { type: "string" },
    ...
    {
        name: "get_spec",
        description: "Get the AIProx agent manifest specification. Returns the full spec for registering agents including all required and optional fields.",
        inputSchema: {
            type: "object",
            properties: {},
            required: [],
...
// MCP SERVER
// ============================================================================
const server = new index_js_1.Server({ name: "aiprox", version: "1.0.0" }, { capabilities: { tools: {} } });
    ...
    try {
        switch (name) {
            case "list_agents": {
                ...
                const list = agents
                    .map((a) => `• ${a.name} — ${a.capability} | ${a.price_per_call} ${a.price_unit}/call | ${a.rail} | ${a.verified ? "✓" : "pending"}`)
                    .join("\n");
                return {
                    content: [
                        {
            ...
            case "find_agent": {
                const { task, preferred_rail } = args;
